...
> このファイルは実装着手前の要件スケッチです。プロジェクト開始時の発想を残すために維持していますが、実装が進むにつれて記述と現状にズレが生じる可能性があります。**現状の内部設計は [`Architecture.md`](Architecture.md)、ユーザー向けの機能・データ形式は [`../README.md`](../README.md)、開発手順は [`Development.md`](Development.md) を参照してください。**
...
- キーボード操作
  ...
  - (トップページ以外) カーソル 上 または Escape でトップページに遷移
